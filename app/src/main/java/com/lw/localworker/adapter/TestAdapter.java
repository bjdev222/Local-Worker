...
public class TestAdapter extends RecyclerView.Adapter<TestAdapter.holder> implements Filterable {
    ...
    public TestAdapter(List<WModel> listData, Context context) {
...
*/
        ...
        Glide.with(context).load(model.getWProfileUrl()).into(holder.profileImage);
    ...
    private Filter exampleFilter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() ==0) {
                ...
                SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
                String filterPattern2 = prefs.getString("Ecity", ""); // get value of last login status
    ...
    private void checkFeedback(String wpNumber, final TestAdapter.holder holder) {
